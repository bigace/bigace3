 ...
 * @version    $Id: AboutController.php 553 2011-01-03 13:01:03Z kevin $
 */
 ...
 * @license    http://www.bigace.de/license.html     GNU Public License
 */
class Admin_FilemanagerController extends Bigace_Zend_Controller_Admin_Action
{
	
	const FINDER_DIR = "elfinder-1.2/";
    ...
    protected function getFinderOptions()
    {
		...
		$start     = $community->getPath('public');
		
		return array(
			'root'            => BIGACE_DIR_PUBLIC_CID,                 // path to root directory
			'URL'             => BIGACE_URL_PUBLIC_CID,                 // root directory URL
			'rootAlias'       => 'Community',       					// display this instead of root directory name
    ...
    {
		$this->view->finderOptions = $this->getFinderOptions();
		$this->view->finderPath    = self::FINDER_DIR;
		$this->view->connectorPath = $this->createLink('filemanager', 'connector');
	}
...
// ===========================================================================================================
//
//        COPIED FROM THE elfinder DOWNLOAD PACKAGE connectors/php/*
//
// ===========================================================================================================
// ===========================================================================================================
